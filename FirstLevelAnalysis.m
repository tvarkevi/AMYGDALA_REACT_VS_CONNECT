...
try
    ...
    confound_regressors = table2array(readtable([confound_regressors_file.folder '\' confound_regressors_file.name]));
    
    spike_regressors_file = dir([scans_dir '\' subject_ID '\' subject_t2_directory '\' subject_ID '*spike_regressors.csv']);
    spike_regressors = table2array(readtable([spike_regressors_file.folder '\' spike_regressors_file.name]));
