...
matlabbatch{1}.spm.spatial.normalise.estwrite.eoptions.tpm = {'O:\MGGZ\Tim\Scripts and Files\Programs\spm12\tpm\TPM.nii'};
...
matlabbatch{2}.spm.spatial.coreg.write.source = '<UNDEFINED>'; % inputs{3}: roi mask
...
matlabbatch{3}.spm.util.defs.comp{1}.inv.space = '<UNDEFINED>'; % inputs{4}: (coregistered) anatomical image
...
matlabbatch{4}.spm.spatial.normalise.write.woptions.bb = '<UNDEFINED>'; % inputs{5}: bounding box of (coregistered) anatomical image
matlabbatch{4}.spm.spatial.normalise.write.woptions.vox = '<UNDEFINED>'; % inputs{6}: voxel size of (coregistered) anatomical image
matlabbatch{4}.spm.spatial.normalise.write.woptions.interp = 4;
matlabbatch{4}.spm.spatial.normalise.write.woptions.prefix = 'i';
matlabbatch{5}.spm.spatial.coreg.write.ref = '<UNDEFINED>'; % inputs{7}: (coregistered) anatomical image
