...
4. The name of the statistical parametric map generated by the first-level analysis (see section 3.4), on which the ROI mask should be applied (for each subject). The con_0001.nii file corresponds to the contrast Pictures (Neutral + Positive + Negative) vs. Baseline, con_0002.nii to the contrast Negative vs. Neutral, con_0003.nii to the contrast Positive vs. Neutral, and con_0004.nii to the contrast Negative vs. Positive, and con_0005.nii to the contrast Negative + Positive vs. Neutral.
