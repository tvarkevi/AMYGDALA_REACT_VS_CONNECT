...
The *roi_matched_regression_analysis* method creates a new subdirectory within the main working directory, which is named after the connectivity prefix (entered in step 2), reactivity contrast image (entered in step 3), and hemisphere of reactivity values (entered in step 4) used for the analysis, and which contains the output files and images of the landscape-based cluster analysis (e.g. working_dir > **roi_matched_regression_connectivity_map_lh_vs_spmT_0001_HemiL**). The *R.mat* file written to this directory is the essential output yielded by the analysis; the other files and images contained by the directory are derived from this main output file.
