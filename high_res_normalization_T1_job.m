%-----------------------------------------------------------------------
% Job saved on 27-Jul-2020 12:23:33 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7487)
...
matlabbatch{1}.spm.spatial.normalise.estwrite.eoptions.tpm = '<UNDEFINED>';
...
matlabbatch{1}.spm.spatial.normalise.estwrite.woptions.prefix = 'high_res_n';
